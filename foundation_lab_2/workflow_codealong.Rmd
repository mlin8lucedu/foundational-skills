...
corresponding to one of three motivation measures: interest, utility value, and perceived competence. These were chosen for their alignment
...
#Don't use view() in the Markdown file
glimpse(survey)
```
