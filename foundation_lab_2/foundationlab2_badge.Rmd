...
3.  Briefly describe any steps of the data-intensive research workflow that detailed in your article or presentation.
    ...
    -   The authors used a mixed methods approach involving social network analysis for selection and influence, and qualitative analyses of
        conversations, individuals' professional roles, and the alignment of chat topics and chat questions with the NGSS.

4.  What were the key findings or conclusions? What value, if any, might education practitioners find in these results?

    -   The authors found that conversations were primarily transactional, or social, and substantive, or providing opportunities for sense-making about the NGSS or for participants to transform their practice. Additionally, researchers, administrators, and teachers
        were the most active in the network
